...
discordLogin.addEventListener('click', () => {
    const url = `https://discord.com/api/oauth2/authorize?client_id=1202415748950265966&response_type=code&redirect_uri=http%3A%2F%2F118.33.154.162%3A9000%2Fmain%2Findex&scope=identify+email`;
